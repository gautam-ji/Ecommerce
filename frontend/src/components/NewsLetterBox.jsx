 ...
 const onSumbitHandler = (e) =>{
  ...
  return ( 
    <div className='text-center'>
      ...
      <p className='text-gray-400 mt-3'>Lorem, ipsum dolor sit amet consectetur inventore id non!</p>
      ...
      <form onSubmit={onSumbitHandler} className='w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border pl-3' >
        <input className='w-full sm:flex-1 outline-none' type='email' placeholder='Enter you email' required/>
         <button type='sumbit' className='bg-black text-white text-xs px-10 py-4'>SUSCRIBE</button>
      </form>
    </div>
  )
}
